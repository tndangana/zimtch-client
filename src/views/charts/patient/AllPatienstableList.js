...
} from '@mui/material'; import { tableCellClasses } from '@mui/material/TableCell';
        ...
        <MainCard content={false} >
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        <Tooltip component={Link} to="/patient/add" title="Add Patient (s)">
            ...
            <TableContainer sx={{ maxHeight: 440 }}>
                <Table stickyHeader aria-label="sticky table">
                    ...
                    <TableBody>
                        {state.patientList.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
            ...
            <TablePagination
                ...
                component="div"
                count={state.patientList.length}
