...
// material-ui
import { Table, TableBody, TableCell, Box, Collapse, TableContainer, IconButton, TableHead, TablePagination, TableRow } from '@mui/material';
                                ...
                                <TableContainer>
                                    ...
                                    >
                                        <Table size="small" aria-label="purchases">
                                            <TableHead>
                                                <StyledTableRow>
                                                    <StyledTableCellSub>Treatment Dtart Date</StyledTableCellSub>
                                                    <StyledTableCellSub>Next Visiting date</StyledTableCellSub>
                                            ...
                                            <TableBody>
                                                {row.diabeticScreeningList?.map((sreen) => (
                                                    <StyledTableRow hover key={sreen.id}>
                                                        ...
                                                        <StyledTableCellSub component="th" scope="row"> {sreen.treatmentDate} </StyledTableCellSub>
                                                        <StyledTableCellSub >{sreen.bloodPressure}</StyledTableCellSub>
                                                        <StyledTableCellSub> {sreen.bloodGlucose}</StyledTableCellSub>
...
export default function AllOnLongTreatMentPatientsTable() {
        ...
        <MainCard content={false} >
            <TableContainer sx={{ maxHeight: 440 }}>
                <Table stickyHeader aria-label="sticky table">
                    ...
                    <TableBody>
                        {state.patientListAdultWith18.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
            ...
            <TablePagination
                ...
                component="div"
                count={state.patientListAdultWith18.length}
