...
const AuthResetPassword = ({ ...others }) => {
    ...
    const { resetPasswordWhenLogout, state } = useAthentication();
    ...
    const changePasswordHandler = async (params) => {
        try {
            ...
            if (username && (params.password === params.confirmPassword)) {

                const payload = {
                    username,
                    password: params.password
                };
                await resetPasswordWhenLogout(payload);
            }
    ...
    return (
        <>
            {
                state.isRessetPasswordLoader ? <CircularProgress color="inherit" /> :
                    <Formik
                        initialValues={{
                            password: '',
                            confirmPassword: '',
