...
const items = [
    {
        title: 'Zimbabwe Technical Assistance, Training & Education Center for Health (Zim-TTECH)',
                            ...
                            <Grid item xs={12}>
                                <Stack direction="row" justifyContent={matchDownSM ? 'center' : 'flex-start'}>
                                    <Typography variant="caption" fontSize="16px" textAlign={matchDownSM ? 'center' : 'inherit'}>
                                        Enter your registration number below and we&apos;ll send you password reset OTP.
                                    </Typography>
                                </Stack>
                            </Grid>
                            <Grid item xs={12}>
